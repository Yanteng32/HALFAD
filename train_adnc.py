...
from configp_ADNC import get_args
import Net.NET_MRI
from Net import HybridLoss
from datetime import datetime

from dataloader_ADNC import load_data
...
def val_model(epoch, val_data, model, log_best):
    ...
    # Write to log file
    log_str = f'Epoch: {epoch}\nTP: {TP} TN: {TN} FP: {FP} FN: {FN} ACC: {ACC} SEN: {SEN} SPE: {SPE} AUC: {AUC}\n'
...
if __name__ == '__main__':
    ...
    experience_log = "DUAL3_PET2_MRI2_dataset14_25_" + str(datetime.now().timestamp())
    ...
    # Load datasets
    train_data = load_data(args, args.train_root_path_MRI, args.train_root_path_PET, args.AD_dir, args.CN_dir)
    test_data = load_data(args, args.test_root_path_MRI, args.test_root_path_PET, args.AD_dir, args.CN_dir)
    val_data = load_data(args, args.val_root_path_MRI, args.val_root_path_PET, args.AD_dir, args.CN_dir)
